...
data_yaml = "/users/k24016446/basketball_analysis/training_notebook/AI-Sports-Analytics-System-7/data.yaml"
epochs = 100
imgsz = 640
batch = 8  # Change to 'batch'

# === Training Execution ===
timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
run_name = f"player_train_{timestamp}"
...
backup_path = f"model_checkpoints/best_player_{timestamp}.pt"
